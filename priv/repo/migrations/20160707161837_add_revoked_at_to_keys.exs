defmodule HexWeb.Repo.Migrations.AddRevokedAtToKeys do
  use Ecto.Migration
  ...
  def up do
    ...
    execute "ALTER TABLE keys ADD CONSTRAINT keys_user_id_name_revoked_at_key UNIQUE (user_id, name, revoked_at)"
  end
