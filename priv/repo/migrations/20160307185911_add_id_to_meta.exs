defmodule HexWeb.Repo.Migrations.AddIdToMeta do
  ...
  def up do
    ...
    execute "UPDATE packages SET meta = json_object_set_key(meta::json, 'id', uuid_generate_v4())::jsonb"
    execute "UPDATE releases SET meta = json_object_set_key(meta::json, 'id', uuid_generate_v4())::jsonb"
  end
