...
Hexpm.Repo.transaction(fn ->
  ...
  # Demo users for the owner-invite typeahead. Each shows a different
  # combination of public contact info. They own no packages so they all
  # appear when searching `tea` from any owner-management page.
  insert(
    :user,
    username: "tea_full",
    full_name: "Tessa Full-Profile",
    emails: [
      build(:email, email: "tessa@example.com", primary: true, public: true, verified: true)
    ],
    handles: %Hexpm.Accounts.UserHandles{
      github: "tessa-fp",
      twitter: "tessa_fp",
      bluesky: "tessa.bsky.social",
      url: "https://tessa.example.com"
    },
    password: password.("teateatea")
  )

  insert(
    :user,
    username: "tea_email_only",
    full_name: "Tom Email-Only",
    emails: [
      build(:email, email: "tom-public@example.com", primary: true, public: true, verified: true)
    ],
    password: password.("teateatea")
  )
  ...
  insert(
    :user,
    username: "tea_socials_only",
    full_name: "Sasha Socials",
    emails: [
      build(:email,
        email: "sasha-private@example.com",
        primary: true,
        public: false,
        verified: true
      )
  ...
  insert(
    :user,
    username: "tea_no_contact",
    full_name: "Mira Minimal",
    emails: [
      build(:email,
        email: "mira-private@example.com",
        primary: true,
        public: false,
        verified: true
      )
  ...
  insert(
    :user,
    username: "tea_url_only",
    full_name: "Wren Website",
    emails: [
      build(:email,
        email: "wren-private@example.com",
        primary: true,
        public: false,
        verified: true
      )
    ],
    handles: %Hexpm.Accounts.UserHandles{url: "https://wren.example.org"},
    password: password.("teateatea")
  )
