...
Today we launched the option for two-factor authentication on hex.pm. Starting today, you can activate 2FA via the hex.pm dashboard. Many thanks to community contributors [Bryan Paxton](https://x.com/starbelly9) and [Jeffrey Liao](https://github.com/jeffreyplusplus) for their work on this project.
