defmodule HexpmWeb.Dashboard.Organization.Components.BillingInfoForms do
    ...
    <div class="tw:bg-white tw:border tw:border-grey-200 tw:rounded-lg tw:overflow-hidden">
      ...
      <div class="tw:px-6 tw:py-5">
        <div class="tw:flex tw:gap-4 tw:border-b tw:border-grey-200 tw:mb-6">
          ...
          <.billing_tab_btn id="billing-tab-btn-company" active={@initial_tab == "company"}
            phx-click={
  ...
  defp person_fields(assigns) do
    ...
    assigns =
      assigns
      |> assign(:emails, BillingHelpers.default_billing_emails(assigns.current_user, assigns.billing_email))
