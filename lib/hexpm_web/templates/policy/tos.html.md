...
By accessing or using the hex.pm, hexdocs.pm or hexorgs.pm websites, HTTP API, repository or associated services (collectively, the "Services") you are agreeing to be bound by this Terms of Service ("Terms"). Six Colors AB ("Six Colors") operates each of these services. Any information, text, graphics or other material on the Services (collectively, the "Content") is also covered by the Terms.

The [Privacy Policy](/policies/privacy) forms part of these Terms. Where you use an organization to publish or consume private packages, the [Data Processing Agreement](/policies/dpa) also forms part of these Terms and governs our processing of personal data on your behalf.
...
Any information that you or other users provide is subject to our [Privacy Policy](/policies/privacy), which governs our collection and use of your information. As part of providing the Services we may send you information; these communications are considered part of the Services and are subject to these Terms.
...
We reserve the right at all times (but will not have an obligation) to remove or refuse to distribute any Content on the Services, to suspend or terminate users and organizations, and to reclaim usernames, organization names or package names without liability to you. We may do so with or without cause and without notice, and we are not obliged to reinstate an account, an organization or any Content.

If we suspend or terminate an organization, its members lose access to the organization's private packages and documentation, and its private packages stop being served to anyone. The organization's Content is retained and deleted as described in Section 9. Subject to Section 8 below and to the [Data Processing Agreement](/policies/dpa), we also reserve the right to access, read, preserve, and disclose any information as we reasonably believe is necessary to satisfy any applicable law, regulation, legal process or governmental request, enforce the Terms, including investigation of potential violations hereof, detect, prevent, or otherwise address fraud, security or technical issues, respond to user support requests, or protect the rights, property or safety of Six Colors, its users and the public.

We take these decisions diligently, objectively and proportionately, having regard to the rights and legitimate interests of everyone involved. We may use automated means, including automated analysis of package contents, to detect Content that may breach these Terms, but a person reviews and takes every decision to remove Content or suspend an account or organization.

Where we restrict Content you have posted, or suspend your account or organization, we will tell you why, unless the law prevents us or the Content is deceptive high-volume commercial content such as bulk spam. We do not operate a formal appeals process and we are not obliged to reconsider a decision, though our policy is to look again if you tell us we got it wrong. Nothing in these Terms affects any right you have to bring proceedings before a court, which are governed by Section 13.

If you believe Content on the Services is illegal, report it to <support@hex.pm>. Tell us where it is, precisely enough that we can find it, why you believe it is illegal, and your name and email address, and confirm that what you have told us is accurate and complete to the best of your knowledge. Copyright complaints go to <copyright@hex.pm> and are handled under Section 7. We will confirm receipt, tell you what we decide, and tell you how you can challenge that decision.
...
Any Content that you submit, post or display on or through the Services is subject to our [Code of Conduct](/policies/codeofconduct), which governs your behavior and Content on the services.

### 7. Copyright Policy

Six Colors respects the intellectual property rights of others and expects users of the Services to do the same. If you believe Content on the Services infringes your copyright, send a notice to <copyright@hex.pm>. The [Copyright Policy](/policies/copyright) sets out what a notice has to contain, how we handle it, and how the affected user can submit a counter notice.

We reserve the right to remove Content alleged to be infringing without prior notice, at our sole discretion, and without liability to you. In appropriate circumstances, Six Colors will also terminate a user's account if the user is determined to be a repeat infringer.

### 8. Private Content

Any Content you submit to the Services for a "private package", including but not limited to package contents, associated documentation, or package metadata (such Content being "Private Content") shall constitute your confidential information. For the duration of these Terms, and on an on-going basis following termination or expiry hereof, Six Colors shall:
...
1. Required by law or regulatory body provided that prior to disclosing such information Six Colors shall give you notice, unless the law prohibits that notice.
2. The information has come into the public domain through no fault of Six Colors.
3. It is known to Six Colors prior to the commencement of these Terms and your use of the Services without any restriction upon its disclosure.
...
You may change or cancel your subscription at any time. There are no credits or refunds for partial billing periods of use, including periods with an active subscription when the Services were not used. If the subscription is cancelled the Services will remain available until the end of the billing period. This does not apply where you terminate under the [Data Processing Agreement](/policies/dpa) because you objected to a new subprocessor or because a data transfer mechanism ceased to be valid, in which case we refund prepaid fees covering the remainder of the term.

Upon payment failure or cancellation of the subscription you will lose access to Services that are non-free, including data submitted or posted using non-free Services. Content will be kept for 90 days, and we may delete it at any time after that. During those 90 days you may request a copy by contacting <support@hex.pm>. If the Services were terminated for breaking these Terms, or the Content violates these Terms, we may stop distributing the Content immediately, and we will still make it available to you on request during those 90 days unless the law prevents us.

By agreeing to these Terms you give us permission to charge your credit card on file. You agree to pay Six Colors any charges incurred through your use of the Services. If you have any disputes contact <support@hex.pm>. You do not need to provide payment information for free usage of the Services.

### 10. Ending These Terms

You may stop using the Services and close your account at any time. The Terms will otherwise continue to apply indefinitely or until terminated by Six Colors. If you stop using the Services the Terms will continue to apply to any information or Content you have submitted or posted to the Services, excluding Content you have explicitly removed from the Services. Nothing in this section shall affect Six Colors' rights to change, limit or stop the provision of the Services without prior notice.
...
The detailed history of changes to these Terms can be found in the [git repository](https://github.com/hexpm/hexpm/blob/main/lib/hexpm_web/templates/policy/tos.html.md) history for this document.

### 13. Governing law and disputes

These Terms, and any dispute arising out of them or out of your use of the Services, are governed by Swedish law, without regard to its conflict of law provisions.

If you use the Services as a consumer rather than in the course of a business, this section does not deprive you of the protection of any mandatory provisions of the law of the country where you live.
