defmodule Hexpm.Application do
  ...
  defp web_children do
    [
      ...
      {Task.Supervisor,
       name: HexpmWeb.SyntaxHighlight.TaskSupervisor,
       max_children: Application.fetch_env!(:hexpm, HexpmWeb.SyntaxHighlight)[:max_children]},
      {Hexpm.Preview.Cache, Application.fetch_env!(:hexpm, Hexpm.Preview.Cache)},
      {Hexpm.Cache,
       name: Hexpm.Cache,
       interval: 3_600_000,
