defmodule Hexpm.Docs.Files do
  ...
  @doc "Every kind found in `files`, as kind => filename."
  ...
  @doc """
  Kinds to list in navigation: those in `resolved` plus `active`, so a link to
  a file the release lacks still shows as the current page.
  """
