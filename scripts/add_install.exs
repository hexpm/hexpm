case System.argv do
  [hex | elixirs] ->
    ...
    HexWeb.Repository.Install.build(hex, elixirs) |> HexWeb.Repo.insert

  _ ->
    :ok
end

all = HexWeb.Repository.Install.all |> HexWeb.Repo.all
...
HexWeb.Repository.RegistryBuilder.partial_build(:v1)
