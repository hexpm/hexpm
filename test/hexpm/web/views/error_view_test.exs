defmodule Hexpm.Web.ErrorViewTest do
  ...
  test "renders 400.html" do
    assert render_to_string(Hexpm.Web.ErrorView, "400.html", conn: conn()) =~ "Bad request"
  end

  test "renders 404.html" do
    assert render_to_string(Hexpm.Web.ErrorView, "404.html", conn: conn()) =~ "Page not found"
  end

  test "renders 408.html" do
    assert render_to_string(Hexpm.Web.ErrorView, "408.html", conn: conn()) =~ "Request timeout"
  end

  test "renders 413.html" do
    assert render_to_string(Hexpm.Web.ErrorView, "413.html", conn: conn()) =~ "Payload too large"
  end
