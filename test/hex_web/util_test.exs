defmodule HexWeb.UtilTest do
  ...
  test "erlang.mk config snippet" do
    ...
    assert Util.erlang_mk_snippet_version(version0) == "0.0.1-dev.0.1"
    assert Util.erlang_mk_snippet_version(version1) == "0.0.2"
    assert Util.erlang_mk_snippet_version(version2) == "0.2.99"
    assert Util.erlang_mk_snippet_version(version3) == "2.0.2"
  end
end
