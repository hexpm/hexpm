defmodule HexWeb.API.DocsControllerTest do
  ...
  test "release docs", c do
    phoenix = Package.build(c.user, pkg_meta(%{name: "phoenix", description: "Web framework"})) |> HexWeb.Repo.insert!
  ...
  test "release beta docs", c do
    plug = Package.build(c.user, pkg_meta(%{name: "plug", description: "Web framework"})) |> HexWeb.Repo.insert!
  ...
  test "delete release with docs", c do
    ecto = Package.build(c.user, pkg_meta(%{name: "ecto", description: "DSL"})) |> HexWeb.Repo.insert!
