defmodule HexWeb.ErrorViewTest do
  ...
  test "renders 400.html" do
    assert render_to_string(HexWeb.ErrorView, "400.html", conn: conn()) =~
           "Bad request"
  end
  ...
  test "renders 408.html" do
    assert render_to_string(HexWeb.ErrorView, "408.html", conn: conn()) =~
           "Request timeout"
  end

  test "renders 413.html" do
    assert render_to_string(HexWeb.ErrorView, "413.html", conn: conn()) =~
           "Payload too large"
  end

  test "renders 415.html" do
    assert render_to_string(HexWeb.ErrorView, "415.html", conn: conn()) =~
           "Unsupported media type"
  end

  test "renders 422.html" do
    assert render_to_string(HexWeb.ErrorView, "422.html", conn: conn()) =~
           "Validation error(s)"
  end
