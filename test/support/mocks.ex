...
Mox.defmock(Hexpm.PackageReports.Varsel.Mock, for: Hexpm.PackageReports.Varsel)
Mox.defmock(Hexpm.CDN.Mock, for: Hexpm.CDN)
Mox.defmock(Hexpm.Store.Mock, for: Hexpm.Store.Behaviour)
